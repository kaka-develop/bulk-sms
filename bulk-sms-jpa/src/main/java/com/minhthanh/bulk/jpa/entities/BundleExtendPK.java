 ...
 */
@Embeddable
public class BundleExtendPK implements Serializable {
    ...
    public boolean equals(Object other) {
		...
		if (!(other instanceof BundleExtendPK)) {
			return false;
		}
		BundleExtendPK castOther = (BundleExtendPK)other;
		return 
